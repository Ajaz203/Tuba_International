    ...
    <div class="modal-overlay" *ngIf="show">
      <div class="modal-content">
        ...
        <div class="booking-details">
          <p class="confirmation-message">Thank you for choosing our service. Your cab booking has been successfully confirmed.</p>
          <div class="booking-info">
            <p><strong>Booking ID:</strong> {{ bookingDetails?.booking_id }}</p>
            <p><strong>Name:</strong> {{ bookingDetails?.name }}</p>
            <p><strong>Pickup:</strong> {{ bookingDetails?.pickup }}</p>
            <p><strong>Date:</strong> {{ bookingDetails?.pickupDate | date:'medium' }}</p>
          </div>
        </div>
        ...
        <div class="support-info">
          <p>For any assistance, contact our 24/7 support:</p>
