...
@Component({
    ...
    templateUrl: './cab-left-sidebar.component.html',
    styleUrl: './cab-left-sidebar.component.scss',
    standalone: true,
    imports: [HeaderComponent, BreadcrumbsComponent, CabSearchComponent, FilterComponent, DetailsComponent, FooterComponent, LayoutComponent]
})
export class CabLeftSidebarComponent {
