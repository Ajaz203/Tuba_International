...
@Component({
    ...
    templateUrl: './hotel-page-theme-breadcrumb.component.html',
    styleUrls: ['./hotel-page-theme-breadcrumb.component.scss'],
    standalone: true,
    imports: [HeaderComponent, HotelGalleryComponent, HotelTabSliderComponent, HotelAboutComponent, HotelRoomsComponent, HotelFacilityComponent, HotelLocationComponent, HotelReviewComponent, HotelPolicyComponent, SinglePageHotelsComponent, HotelSinglePageFilterComponent, HotelSinglePageModalComponent, FooterComponent, LayoutComponent]
})
export class HotelPageThemeBreadcrumbComponent {
