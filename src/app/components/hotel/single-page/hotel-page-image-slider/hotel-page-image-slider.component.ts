...
import { HotelImageSliderComponent } from '../widgets/hotel-image-slider/hotel-image-slider.component';
import { HeaderComponent } from '../../../../shared/components/header/header.component';

@Component({
    selector: 'app-hotel-page-image-slider',
    templateUrl: './hotel-page-image-slider.component.html',
    styleUrls: ['./hotel-page-image-slider.component.scss'],
    standalone: true,
    imports: [HeaderComponent, HotelImageSliderComponent, HotelTitleSectionComponent, HotelTabSliderComponent, HotelAboutComponent, HotelRoomsComponent, HotelFacilityComponent, HotelLocationComponent, HotelReviewComponent, HotelPolicyComponent, SinglePageHotelsComponent, HotelSinglePageFilterComponent, HotelSinglePageModalComponent, FooterComponent, LayoutComponent]
})
export class HotelPageImageSliderComponent {
