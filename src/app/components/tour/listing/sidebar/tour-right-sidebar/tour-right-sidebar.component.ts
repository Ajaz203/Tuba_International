...
@Component({
    ...
    templateUrl: './tour-right-sidebar.component.html',
    styleUrls: ['./tour-right-sidebar.component.scss'],
    standalone: true,
    imports: [HeaderComponent, BreadcrumbsComponent, GridPanelComponent, SearchBoxComponent, DetailsComponent, FilterComponent, FooterComponent, LayoutComponent]
})
export class TourRightSidebarComponent {
