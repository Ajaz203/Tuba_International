...
@Component({
    ...
    templateUrl: './restaurant-google-map-modal.component.html',
    styleUrl: './restaurant-google-map-modal.component.scss',
    standalone: true,
...
export class RestaurantGoogleMapModalComponent {
